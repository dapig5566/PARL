...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model: int, nhead: int, d_hid: int,
                 enc_nlayers: int, dec_nlayers, dropout: float = 0.5):
        super().__init__()
        ...
        self.transformer_decoder = TransformerDecoder(decoder_layers, dec_nlayers)
    ...
    def forward(self, src: Tensor, tgt, src_mask: Tensor, tgt_mask):
        """
        Args:
